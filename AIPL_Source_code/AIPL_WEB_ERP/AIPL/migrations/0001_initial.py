# Generated by Django 3.2.6 on 2024-10-21 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_by', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='received_tasks_add', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sent_tasks_add', to=settings.AUTH_USER_MODEL)),
            ],
            options={
